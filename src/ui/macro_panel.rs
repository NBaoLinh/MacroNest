    ...
    fn render_custom_preset_step_draft_popup(
        ...
        if open {
            ...
            let area_response = area.show(ui.ctx(), |ui| {
                ...
                frame = frame.fill(fill).stroke(egui::Stroke::new(1.5, stroke_color));
                ...
                frame.show(ui, |ui| {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        changed |= ui.radio_value(&mut step.command_preset_use_powershell, false, "CMD").changed();

                        ui.add_space(4.0);

                        changed |= ui.radio_value(&mut step.command_preset_use_powershell, true, "PowerShell").changed();
                                        ...
                                        ui.horizontal(|ui| {
                                            ...
                                            child_ui.scope(|ui| {
                                                ...
                                                let (toggle_changed, new_enabled) = ui.scope(|ui| {
                                                    let resp = Self::enabled_icon_button(ui, step.enabled)
    ...
    pub(crate) fn render_variable_inspector(&mut self, ui: &mut egui::Ui) {
        ...
        ui.vertical(|ui| {
            ...
            ui.horizontal(|ui| {
                ...
                let mut name_buf = ui.memory(|mem| mem.data.get_temp::<String>(id_const_name).unwrap_or_default());

                let mut val_buf = ui.memory(|mem| mem.data.get_temp::<String>(id_const_val).unwrap_or_default());
                ...
                if ui.button(Self::tr_lang(language, "Add", "Add")).clicked() {
                    ...
                    if !name_trimmed.is_empty() {
                        ...
                        if !self.state.global_constants.iter().any(|(n, _)| n == &name_trimmed) {

                            self.state.global_constants.push((name_trimmed.clone(), parsed_val));
                        ...
                        egui::Grid::new("macro_vars_grid")
                            ...
                            .show(ui, |ui| {
                                ...
                                for name in &vars_list {
                                    ...
                                    ui.label(RichText::new(name).monospace().color(Color32::from_rgb(243, 156, 18)));
